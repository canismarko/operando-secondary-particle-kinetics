...
\begin{figure}
  ...
  \caption{\nca{} \gls{uxrd}. (a-c) Maps of summed diffraction
    intensity for particles 1, 2, and 3 repsectively. (d)
    Whole-pattern LeBail refinement for summed diffraction intensity
    of particle 1 in its pristine state. Ticks show expected positions

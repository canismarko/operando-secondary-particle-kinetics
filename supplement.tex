...
\begin{subequations}
  \begin{align}
    -D_p\frac{\partial c_{p,k}}{\partial r}\vert_{r=R_{p,k}} &= J_{k} \label{eq:1b} \\
    -D_p\frac{\partial c_{p,k}}{\partial r}\vert_{r=0} &= 0 \label{eq:1c}
    \end{align}
\end{subequations}
...
\begin{equation}
  \frac{\partial c_{p,k}}{\partial t}=\frac 1{\psi{}_k}\nabla \cdot \psi{}_kD_p\nabla c_{p,k}+\frac{\left\vert\nabla \psi{}_k\right\vert}{\psi{}_k}J_k
  \label{eq:8}
\end{equation}
...
used $\delta = \SI[parse-numbers=false]{\sqrt{2}}{\micro\meter}$.

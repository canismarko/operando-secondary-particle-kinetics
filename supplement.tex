...
\begin{figure}
  \centering
  \includegraphics[width=0.5\linewidth]{figures/NCA-particles-refined.pdf}
  \caption{Sample \nca{} diffraction data. a-c) Maps of summed
    diffraction intensity for particles 1, 2, and 3 repsectively. d,e)
    Diffraction patterns for mapping particle one, mapping position
    x=\SI{6}{\micro\meter} and y=\SI{3}{\micro\meter} in particle 1 at
    d) OCV and e) \SI{\approx4}{\volt}. Vertical lines indicate
    expected peaks positions based on refined unit cell dimensions.}

...
\begin{figure}
  ...
  \caption{\nca{} \gls{uxrd}. (a-c) Maps of summed diffraction
    intensity for particles 1, 2, and 3 repsectively. (d,e)
    Whole-pattern refinement for summed diffraction intensity of
    particle one at (d) OCV and (e) after first charge. Ticks show
    expected positions for reflections of \nca{} with $\rm{R\bar{3}m}$
    space group.}

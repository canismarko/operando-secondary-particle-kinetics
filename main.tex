...
\citeme{Robert2015a}. There was an extra feature that varied in
...
\emph{operando} \gls{xrd} of the ensemble average\citeme{Robert2015},
as opposed to individual particles in \nca{} electrodes, in prior
work\citeme{Grenier2017}. \gls{p2} (\ref{fig:xrd-echem}b) also
...
present\citeme{Robert2015}. In turn, the subsequent collapse is driven
...
of an electrode available in the literature\citeme{Robert2015a}. The
...
\gls{xrd} in Robert \emph{et al}\citeme{Robert2015}. In this reference
...
\citeme{Tarascon1996}. A mixture of \nca{}, poly(vinylidene
...
the FIT2D software package developed by ESRF \citeme{Hammersley1996,
  Hammersley1997}. The integrated data was processed with the Scimap
analysis package \citeme{Wolfman2015}, in which the determination of the

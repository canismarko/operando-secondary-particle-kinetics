...
\begin{abstract}
  ...
  has focused on the global behavior of the electrode. This approach is subject of misleading analyses controlled by idiosyncratic kinetic conditions, such as surface impurities inducing an apparent
  ...
  two-phase transitions for the ensemble of the electrode. Operando \gls{uxrd} leverages the relationship between Li content and cell parameter to reveal that rate acceleration systematically occurs between \gls{xLi} $\approx 0.9$ and $\approx 0.4$ for \nca{}. Physics-based modeling shows
...
\begin{itemize}
\item https://www.nature.com/articles/s41467-021-25686-1
...
different layered oxides to sluggish \ce{Li^+} transport in the Li-rich phase. Clearly, there is
...
studied using the \glsreset{ecd}\gls{ecd}. Similarly, the effect of the transport of
\ce{Li+} can be studied using the \glsreset{D_s}\gls{D_s}. Both of these quantities

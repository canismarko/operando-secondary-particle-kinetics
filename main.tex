\documentclass[sn-mathphys,referee,lineno]{sn-jnl}
...
\usepackage{siunitx}
%% \usepackage{glossaries}  %% Moved to the sn-jnl.cls file so it can be loaded in the right order
...
\newacronym{ssrl}{SSRL}{the Stanford Synchrotron Radiation Lightsource}
\newacronym{aps}{APS}{the Advanced Photon Source, Argonne National Laboratory}
...
\newacronym{D_s}{\ensuremath{D_s}}{coefficient of Li diffusivity in particles}
...
\author[1,2]{\fnm{Mark} \sur{Wolfman}}
\author[1]{\fnm{Brian M.} \sur{May}}
\author[3]{\fnm{Vishwas} \sur{Goel}}
\author[3]{\fnm{Sicen} \sur{Du}}
\author[4,5]{\fnm{Young-Sang} \sur{Yu}}
\author[1]{\fnm{Chao} \sur{Li}}
\author[3]{\fnm{Katsuyo} \sur{Thornton}}
\author[1]{\fnm{Jordi} \sur{Cabana}}

\affil[1]{\orgdiv{Department of Chemistry} \orgname{University of Illinois at Chicago}}
\affil[2]{\orgdiv{Division of Chemical Sciences and Engineering} \orgname{Argonne National Laboratory}}
\affil[3]{\orgdiv{Department of Materials Science and Engineering} \orgname{University of Michigan}}
\affil[4]{\orgdiv{Department of Physics} \orgname{Chungbuk National University}}
\affil[5]{\orgdiv{Advanced Light Source} \orgname{Lawrence Berkeley National Laboratory}}
...
delithiation to limited diffusion of \ce{Li} in the cathode active
...
crystal cathode behavior implies that \ce{Li} diffusion may be the

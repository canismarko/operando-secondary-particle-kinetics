...
charge\ref{tsai2018}, these fractures represent movement of transition
metal within the particle and so are not expected to directly effect
the whole-particle spectra presented here. \gls{xas} measurements of
the ensemble average of electrodes showed that, upon delithiation,
...
limited \ce{Li+^} transport will require some particles to reach
...
(Table \zref{si:tab:bulk-xas-extraction}). This implies that a portion
...
(Figure \zref{si:fig:xrd-echem}c). More deliberate design of the

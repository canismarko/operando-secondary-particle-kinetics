...
shape (Figure \ref{fig:txm-nmc}a). Since no ensemble-average
measurements were performed, the mean optical depth for all foreground
pixels in the frame was used for evaluating overall oxidation (Figures
\ref{fig:txm-nmc}b,c). Similarly to \nca{}, spectra for both \nmc{}
cathodes showed an increase in the whiteline energy. \nmc[333]{}
exhibited a lower initial whiteline energy. The \ce{Mn{3+}/Mn{4+}}
redox couple has a higher reduction potential than the
\ce{Ni{2+}/Ni{3+}} couple, which resulted in the spontaneous formation
of \ce{Ni^{2+}} limited by the concentration of manganese (lower in

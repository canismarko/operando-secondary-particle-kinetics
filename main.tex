...
reaching \SIrange{75}{100}{\percent} state-of-charge. Several sets
particles oxidized simultaneously, though no clear primary set
emerged. This particle-level behavior is in contrast with the that
seen by in-situ ensemble-average \gls{xas}\cite{deb2005}, which showed
a gradual increase in whiteline position over the full range of
delithiation. This rapid oxidation behavior was in agreement with that
observed by \gls{uxrd} (Figure \ref{fig:uxrd}).

During discharge (Figure \ref{fig:nmc-particles}a), the
particles' whitelines gradually moved to lower energies, indicating
gradual reduction of \ce{Ni}.
...
Instead of simply selecting the energy with maximum
optical depth for a given pixel, the full spectrum at each \gls{txm}
pixel was fit, after which the whiteline energy was extracted from the
fit parameters. This approach was more tolerant of noise, and provided
higher precision than the energy resolution of the instrument.
...
therefore different whiteline positions, whiteline energies were
...
Five out of the six
particles underwent this rapid oxidation simultaneously, while the
...
The total change in whiteline energy for all observed
secondary particles was \SI{>4}{eV} (Figure \ref{fig:txm-nmc}d). While
ensemble \gls{xas} studies\cite{deb2005,muto2009} did not reach the
\SI{4.7}{V} cell cut-off potential needed for full lithium extraction
and hence full \ce{Ni} oxidation, extrapolation of the trend in Table

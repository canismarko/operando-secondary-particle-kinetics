...
dynamics of these materials warrant further study to identify the origin of the rapid delithiation behavior (xxxx) in secondary particles that typically compose a cathode. 


clarify the nature of the chemical transformation, especially in view of locating the onset and progression of heterogeneity, within and
...
\gls{ecd} ($\propto\sqrt{{x_{Li}}(1-{x_{Li}})}$ \cite{newman1993,
...
experiment. Indeed, the simulation result also shows this \todo{XXXX} for
...
(\SI{0.5}{\second} exposure time, \ysy{get value}{10} repetitions,
...
exposure time, \ysy{get value}{10} repetitions, binning 2, $\rm 1024
...
in \ysy{get value}{37 minutes}. \Gls{od} images were aligned with

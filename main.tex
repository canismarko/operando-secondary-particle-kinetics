...
\begin{itemize}
\item zhao2022\cite{zhao2022}: \url{https://pubs.acs.org/doi/pdf/10.1021/acs.nanolett.2c01818}
...
delithiation compared to \nca{}\cite{yoon2006,hua2018}. In a separate work, the reflectivity of \nmc[532]{} to visible light was used to detect oxidation, again revealing asynchronous and rapid delithiated\cite{zhao2022}. Here, the cause was attributed to changes in electrical conductivity of the active material and the connectivity to the conductive matrix of the electrode. Merryweather et al.\cite{rao2021}\ showed rapid delithiation
in \ce{LiCO2} single crystal particles through \gls{iscat}, though
the authors attributed this behavior to changes in \ce{Li^+} diffusion. Similarly, Ge et al.\cite{wang2020-6}\ showed rapid
delithiation in \nmc{} single crystal particles using operando
\gls{txm}-\gls{xas}, and attributed this to \ce{Li^+} diffusion
limitations by way of finite element analysis. There is no clear consensus on the origin of this rapid delithiation behavior in layered cathode particles. The oxidation
dynamics of these materials warrant further study to clarify the nature of the chemical transformation, especially in view of locating the onset and progression of heterogeneity, within and
